...
file = basepath + "images/Betatron/ebeam_pointing/877_A=2.8_ND08+ND04_195157_.png"
...
ebeam_anaylsis.crop_image(left=462, right=630, top=620, bottom=730,
                          save_file=basepath + "results/ebeam/pointing/ebeam_pointing_cropped_betatron.png",
                          verbose=True)
...
ebeam_anaylsis.plot_fields_fit(save_file=basepath + "results/ebeam/pointing/" +
                               "ebeam_pointing_analysis_betatron.png",
                               xlim=(-5, 5), ylim=(-5, 5),
                               clim=(0, 8e2), cmap='magma')
