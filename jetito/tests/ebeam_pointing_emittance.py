...
file = "Images/Emittance_Experiment_2022/ebeam_pointing/shot00450.tif"
...
ebeam_anaylsis.crop_image(left=300, right=1260, top=1350, bottom=1970, 
              save_file="results/ebeam/pointing/ebeam_pointing_cropped.png", verbose=True)
...
ebeam_anaylsis.plot_fields_fit(save_file="results/ebeam/pointing/ebeam_pointing_analysis.png",
                   xlim=(-6, 6), ylim=(-5, 5), clim=(0,600), cmap='magma')
