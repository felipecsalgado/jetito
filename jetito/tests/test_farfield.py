...
FF.plot_fields(save_file="results/farfield/NF_FF_full_beam_Jeti.png")

FF.ff_2dgaussian_fit()

FF.getQfactor()

FF.plot_fields_fit(save_file="results/farfield/NF_FF_full_beam_Jeti_ElecAcc2023_fit.png")