...
file = "Images/JETi-200/ebeam_pointing/386_LWFA_Zelle_He5N2_Pointing_ESpeklow_182542_.png"
...
ebeam_anaylsis.crop_image(left=670, right=1140, top=305, bottom=690, 
              save_file="results/ebeam/pointing/ebeam_pointing_cropped_jeti.png", verbose=True)
...
ebeam_anaylsis.plot_fields_fit(save_file="results/ebeam/pointing/ebeam_pointing_analysis_jeti.png",
                   xlim=(-6, 6), ylim=(-7, 1), clim=(0,1.5e3), cmap='magma')
