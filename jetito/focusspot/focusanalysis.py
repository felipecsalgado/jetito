...
class focusspot_analysis:
    ...
    def __init__(self, filename, image_calib=0.4):
        ...
        Args:
            ...
            image_calib (double, optional): Calibration of the near-field image in units of length/pixel (typical: um/pixels). Defaults to 0.4.
        """
    ...
    def plot_fields_fit(self, save_file=None, xlim=None, ylim=None, clim=None, **kwargs):
        ...
        _=ax.text(0.07, 0.125, text_legend, horizontalalignment='left', color='white', fontsize=10, weight='bold',
        ...
        text_legend2 = ("$\sigma_y$ = %.1f \u03BCm\n" + 
                        ...
                        "q-factor = %.1f %%")%( self.popt_fit[4], 
                                                ...
                                                self.q_factor)
        _=ax.text(0.55, 0.125, text_legend2, horizontalalignment='left', color='white', fontsize=10, weight='bold',
                verticalalignment='center', transform=ax.transAxes)
